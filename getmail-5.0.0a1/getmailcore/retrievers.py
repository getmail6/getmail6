...
import getmailcore.sslwrappers
...
class SimplePOP3SSLRetriever(POP3RetrieverBase, POP3SSLinitMixIn):
    ...
    _confitems = (
        ...
        ConfString(name='certificatemode', required=False, default='required'),
        ConfFile(name='cacertificatesfile', required=False, default=None),
    )
    _extraconfchecks = (
        getmailcore.sslwrappers.checkSslOptions,
    )
    received_from = None
